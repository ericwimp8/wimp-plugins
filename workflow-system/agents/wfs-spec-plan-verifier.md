...
**The difference:** "Should handle edge cases" is a requirement (not your concern). "Returns UserProfile" is a factual claim (you verify if it's true).
